...
from andakia import Andakia, AsyncAndakia, APIResponseValidationError
from andakia._types import Omit
from andakia._models import BaseModel, FinalRequestOptions
from andakia._constants import RAW_RESPONSE_HEADER
from andakia._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from andakia._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Andakia | AsyncAndakia) -> int:
...
class TestAndakia:
    client = Andakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "andakia/_legacy_response.py",
                        "andakia/_response.py",
    ...
    def test_multipart_repeating_array(self, client: Andakia) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ANDAKIA_BASE_URL="http://localhost:5000/from/env"):
            client = Andakia(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Andakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Andakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Andakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Andakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Andakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("andakia._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/login").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/login",
                body=cast(object, dict(email="email", password="xxxxxxxx")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/login").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/login").mock(side_effect=retry_handler)

        response = client.authentication.with_raw_response.login(email="email", password="xxxxxxxx")
    ...
    def test_omit_retry_count_header(
        self, client: Andakia, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.authentication.with_raw_response.login(
            email="email", password="xxxxxxxx", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.authentication.with_raw_response.login(
            email="email", password="xxxxxxxx", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncAndakia:
    client = AsyncAndakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAndakia) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ANDAKIA_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAndakia(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncAndakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAndakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAndakia) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAndakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncAndakia(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.authentication.with_raw_response.login(email="email", password="xxxxxxxx")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAndakia, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.authentication.with_raw_response.login(
            email="email", password="xxxxxxxx", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from andakia._utils import asyncify
        from andakia._base_client import get_platform 
